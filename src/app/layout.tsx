...
export const metadata: Metadata = {
  ...
  description: "PassProtector is a modern and secure password manager that helps you generate, store, and manage strong passwords effortlessly. Enhance your online security with encryption, passphrase generation, password generation, and real-time strength analysis.",
  category: "password manager web app",
  applicationName: "PassProtector",
  keywords: ["password manager", "password generator", "password strength", "encryption", "passphrase generator", "security", "online security"],
  robots: "index, follow",
  openGraph: {
    title: "PassProtector | Secure Your Passwords Effortlessly",
    description: "PassProtector is a modern and secure password manager that helps you generate, store, and manage strong passwords effortlessly. Enhance your online security with encryption, passphrase generation, password generation, and real-time strength analysis.",
