/*
  ...
  - The values [weak,medium,strong] on the enum `PasswordStrength` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PasswordStrength_new" AS ENUM ('Weak', 'Medium', 'Strong');
